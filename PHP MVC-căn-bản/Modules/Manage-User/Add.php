...
if (!is_admin()){
    redirect(base_url(''), array('m' => 'Passport', 'a' => 'Logout'));
}
?>
...
<form id="main-form" method="post" action="<?php echo create_link(base_url('index.php'), array('m' => 'Manage-User', 'a' => 'Add')); ?>">
        ...
        <tr>
            ...
            <td>
                <select name="level">
                    ...
                    <option value="1" <?php echo (input_post('level') == 1) ? 'selected' : ''; ?>>Quản lý</option>
                    <option value="2" <?php echo (input_post('level') == 2) ? 'selected' : ''; ?>>Thành viên</option>
                </select>
