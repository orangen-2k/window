<?php if (!defined('IN_SITE')) die ('The request not found');
    ...
    if (!is_admin()){
        redirect(base_url(''), array('m' => 'Passport', 'a' => '404'));
    }
    ?>
...
<div class="controls">
    <a class="button" href="<?php echo create_link(base_url(''), array('m' => 'Manage-User', 'a' => 'Add')); ?>">Thêm</a>
</div>
<table cellspacing="0" cellpadding="0" class="form">
    ...
    <tbody>
        ...
        <tr>
            ...
            <?php if (is_supper_admin()){ ?>
            <td>
                <form method="POST" class="form-delete" action="<?php echo create_link(base_url('index.php'), array('m' => 'Manage-User', 'a' => 'Delete')); ?>">
                    <a href="<?php echo create_link(base_url(''), array('m' => 'Manage-User', 'a' => 'Show', 'id' => $item['id'])); ?>">Show</a>
                    <a href="<?php echo create_link(base_url(''), array('m' => 'Manage-User', 'a' => 'Edit', 'id' => $item['id'])); ?>">Edit</a>
