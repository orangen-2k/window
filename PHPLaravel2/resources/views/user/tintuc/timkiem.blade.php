...
{{--                                                        @if(count($item->loaitin) > 0)--}}
                                                                ...
                                                                <div class="entry-content">
                                                                    <div class="content-top clearfix">
                                                                        <div class="content-top-in">
                                                                            ...
                                                                            <div class="entry-title">
                                                                                <h4><a href="post_format_image.html">{!! doimau($item->ten, $Tukhoa) !!}</a></h4>
                                                                                    {{$item->ten}}
                                                                                <div>
                                                                                    <div class="col-md-8">
                                                                            ...
                                                                            <div class="entry-meta clearfix">
                                                                                ...
                                                                                <div class="entry-comment meta-entry">
                                                                                    ...
                                                                                    <a href="blog_left_sidebar.html" rel="tag">Couples</a>,
                                                                                    <a href="blog_left_sidebar.html" rel="tag">Wedding</a>
                                                                                </div>

                                                                                <div class="entry-comment meta-entry">
                                                                                    <i class="fas fa-eye"></i>
                                                                                    <a href="blog_left_sidebar.html" rel="tag">222</a>
                                                                                    <a href="blog_left_sidebar.html" rel="tag">view</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="readmore">
                                                                        <a href="post_format_image.html"><i class="fa fa-caret-right"></i>Read More</a>
                                                                    </div>
                                                                </div><br/><br/><br/>
                                                            @endforeach
{{--                                                        @endif--}}
